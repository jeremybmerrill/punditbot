...
# 138 chars: "Prep_phrase pre has not lost the White House since 1988 in any year when asparagus use grew from the previous election year, besides 2004."

# 137 chars: "After 1988 in any year when asparagus use grew from the previous election year, except 2004, prep_phrase pre has not lost the presidency."
# 139 chars: "After 1988 in any year when asparagus use grew from the previous election year, besides 2004, prep_phrase pre has not lost the White House."
# 136 chars: "Prep_phrase pre have lost the presidency since 1988 in every year when asparagus use grew from the previous election year, besides 2004."
# 136 chars: "Prep_phrase pre has not lost the presidency since 1988 in any year when asparagus use grew from the previous election year, except 2004."
# 137 chars: "Prep_phrase pre have lost the White House since 1988 in every year when asparagus use grew from the previous election year, besides 2004."
